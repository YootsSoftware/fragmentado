...
export default function AuthCard({
  ...
  return (
    <section
      className={`${styles.card} ${styles.authShellCard} ${authSubmitting ? styles.authShellCardSubmitting : ''}`}
    ...
    >
      ...
      <div
        className={`${styles.authFormPane} ${authSubmitting ? styles.authFormPaneSubmitting : ''}`}
      >
        {authSubmitting ? (
          ...
          <>
            ...
            <form
              className={`${styles.form} ${styles.authForm}`}
              onSubmit={onSubmit}
              onKeyDown={onKeyDown}
            >
              ...
              <button type="submit" className={styles.authSubmit}>
                {isBootstrap ? 'Crear cuenta' : 'Entrar'}
              </button>
            </form>
          </>
        )}
